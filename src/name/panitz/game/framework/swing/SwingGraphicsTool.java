...
public class SwingGraphicsTool implements GraphicsTool<Image> {
  ...
  public void drawString(double x, double y, int fontSize, String fontName, String text) {
    ...
    g.setColor(new Color(255, 251, 253));
    g.drawString(text, (int) x, (int) y);
  }

  // TODO
  @Override
  public void drawString(double x, double y, int fontSize, String fontName, String text, int fontStyle) {
    g.setFont(new Font(fontName, fontStyle, fontSize));
    g.setColor(new Color(255, 251, 253));
    g.drawString(text, (int) x, (int) y);
    //g.setColor(new Color(21, 250, 51));
  }
